...
public class Product implements Serializable {
  ...
  public void addCat(Set<Category> categories) {
  ...
  public Set<Category> getCategories() { //get().add(CAT?) assim que insere a cat

    return categories;
  }
  
  //Buscando Lista de orders em casa OrderItem do produto
